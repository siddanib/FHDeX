...
def realization_process (itr, n_steps, N_left, N_right, ncells,
    ...
    for i_step in range(n_steps):
        ...
        output_batch *= ((dt**0.5)/dx)*std_scale
        # Shift the mean based on (N_left-N_right)
        output_batch += (0.5*dt/(dx*dx))*(N_left_t-N_right_t)
