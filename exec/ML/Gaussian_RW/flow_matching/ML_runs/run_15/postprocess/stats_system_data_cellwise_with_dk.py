...
#ml_parent_folder = "./outputs/2026-03-03/12-22-06/"
ml_parent_folder = "./outputs/2026-03-03/13-38-04/"

#dk_parent_folder = "./outputs/2026-03-03/17-39-38/"
dk_parent_folder = "./outputs/2026-03-03/17-43-53/"

ml_npz_file = "total_data.npz"
ml_npz_file = os.path.join(ml_parent_folder,ml_npz_file)
aa = np.load(ml_npz_file)
...
for n_step in [1, 10, 50, 250, 500]:
    ...
    ax[0,1].plot(dk_dens_var[n_step,:],color="green",label="DK")
    ...
    ax[1,0].plot(dk_dens_skew[n_step,:],color="green",label="DK")
    ...
    ax[1,1].plot(dk_dens_kurt[n_step,:],color="green",label="DK")
    ...
    plt.tight_layout()
    plt.savefig(f"n_step_{n_step}_with_DK"+".jpeg")
    #plt.show()
