...
#### HERE MODEL refers to DK #################

#parent_folder = "./outputs/2026-03-03/17-39-38/"
parent_folder = "./outputs/2026-03-03/17-43-53/"
...
for directory in dir_list:
    ...
    for ii, fl_nm in enumerate(h5_files):
        ...
        with h5py.File(data_file, mode="r") as f:
            ...
            model_density_data[ii,:,:] = f["dk_density_data"][:]
            particle_flux_data[ii,:,:] = f["ptcl_flux_data"][:]
            model_flux_data[ii,:,:] = f["dk_flux_data"][:]
    ...
    np.savez(os.path.join(directory,npz_file),
             ...
             dk_density_data = model_density_data,
             particle_flux_data = particle_flux_data,
             dk_flux_data = model_flux_data
            )
